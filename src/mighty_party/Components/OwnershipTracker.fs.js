    ...
    switch (msg.tag) {
        ...
        case 3: {
            ...
            const filter = contains(filterValue, state.Filter, {
                ...
                const activePatternResult11341 = $007CBefore$007C_$007C("-")(_arg1);
                if (activePatternResult11341 != null) {
                    if ($007CStartsWith$007C_$007C(k)(activePatternResult11341) != null) {
                        pattern_matching_result = 0;
                    }
                    else {
                        pattern_matching_result = 1;
...
export function OwnTracking_applyFilter(heroes, ownedIds, filters) {
    const $007CFilter$007C_$007C = (_arg1) => {
        ...
        const activePatternResult11364 = $007CBefore$007C_$007C("-")(_arg1);
        if (activePatternResult11364 != null) {
            const activePatternResult11365 = $007CAfter$007C_$007C("-")(_arg1);
            if (activePatternResult11365 != null) {
                pattern_matching_result = 0;
                f = activePatternResult11364;
                v = activePatternResult11365;
            }
            else {
                pattern_matching_result = 1;
            }
    ...
    return fold((heroes_1, _arg2) => {
        let activePatternResult11371, v_2, activePatternResult11373, v_3;
        ...
        if (activePatternResult11377 != null) {
            if (activePatternResult11377[0] === "Alignment") {
                pattern_matching_result_1 = 0;
                a = activePatternResult11377[1];
            }
            else {
        ...
        switch (pattern_matching_result_1) {
            ...
            case 1: {
                ...
                if (activePatternResult11376 != null) {
                    if (activePatternResult11376[0] === "Rarity") {
                        pattern_matching_result_2 = 0;
                        r = activePatternResult11376[1];
                    }
                    else {
                ...
                switch (pattern_matching_result_2) {
                    ...
                    case 1: {
                        ...
                        if (activePatternResult11375 != null) {
                            if (activePatternResult11375[0] === "Owned") {
                                if (activePatternResult11375[1] === "Owned") {
                        ...
                        switch (pattern_matching_result_3) {
                            ...
                            case 1: {
                                const activePatternResult11374 = $007CFilter$007C_$007C(_arg2);
                                if (activePatternResult11374 != null) {
                                    const n = activePatternResult11374[0];
                                    const v_1 = activePatternResult11374[1];
                                    toConsoleError(printf("No Filter found for %s - %s"))(n)(v_1);
                                    return heroes_1;
                                }
                                else {
                                    const x = _arg2;
                                    const fName = (activePatternResult11371 = $007CBefore$007C_$007C("-")(x), (activePatternResult11371 != null) ? ((v_2 = activePatternResult11371, v_2)) : (void 0));
                                    const fValue = (activePatternResult11373 = $007CAfter$007C_$007C("-")(x), (activePatternResult11373 != null) ? ((v_3 = activePatternResult11373, v_3)) : (void 0));
