...
export function render(state, dispatch) {
    ...
    const children_4 = ofArray([renderNav(dispatch), (children_2 = toList(delay(() => {
        let activePatternResult11481, e;
        return append_1((activePatternResult11481 = $007CValueString$007C_$007C(state.Error), (activePatternResult11481 != null) ? ((e = activePatternResult11481, singleton_1(createElement("span", {
            className: "is-red",
            children: e,
        })))) : ((empty()))), delay(() => {
